 ...
 * OauthRefreshToken
 *
 * @ORM\Table(name="oauth_refresh_token", indexes={@ORM\Index(name="expires_at", columns={"expires_at"}), @ORM\Index(name="user_id", columns={"user_id"}), @ORM\Index(name="id", columns={"id"}), @ORM\Index(name="client_id", columns={"client_id"})})
 * @ORM\Entity
 */
